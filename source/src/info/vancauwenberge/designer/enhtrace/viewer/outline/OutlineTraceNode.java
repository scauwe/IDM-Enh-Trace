...
class OutlineTraceNode implements IOutlineParentNode {
	private String label = null;
	List<OutlineThreadNode> children= new ArrayList<OutlineThreadNode>();
	
	OutlineTraceNode(String label){
		this.label = label;
	}


	public void addChild(OutlineThreadNode message){
