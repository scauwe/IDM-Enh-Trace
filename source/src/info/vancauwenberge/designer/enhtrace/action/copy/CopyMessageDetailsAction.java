...
public class CopyMessageDetailsAction extends Action {
	private final ILogMessage message;

	public CopyMessageDetailsAction(String menuLabel, ILogMessage message) {
		super(menuLabel);
	...
	public void run(){
		...
		cb.setContents(new Object[] { message.getMessageDetail() }, new Transfer[] { textTransfer });
		}
}